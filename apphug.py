...
config_path = "/kaggle/working/MagicAnimate-hf/configs/config.json"
config_update = {
    "pretrained_model_path": "/kaggle/working/MagicAnimate-hf/stable-diffusion-v1-5",
    "pretrained_appearance_encoder_path": "/kaggle/working/MagicAnimate-hf/MagicAnimate/appearance_encoder"
}
...
with open(config_path, 'w') as config_file:
    json.dump(config_update, config_file)

# Load the config
with open(config_path, 'r') as config_file:
    config = json.load(config_file)

# Update paths in MagicAnimate class if necessary
class Config:
    pretrained_model_path = config["pretrained_model_path"]
    pretrained_appearance_encoder_path = config["pretrained_appearance_encoder_path"]

# Initialize the animator
animator = MagicAnimate(Config)
